    ...
    <el-row>
      <el-col>
        ...
        >
          ...
          <el-table-column label-class-name="warning-row" prop="teaching_project_province_num" label="教师主持省级以上教学项目数" :sortable="true">
          </el-table-column>
...
<script>
import { fetchList } from "@/api/teachingProjectProvince";
